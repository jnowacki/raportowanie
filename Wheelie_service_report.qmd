...
*A: tutaj w tooltipie dodałabym średni koszt serwisu danego samochodu - tzn brakuje mi informacji czemu za dany model placimy ile placimy, czy zalezy to od liczby samochodu czy koszty serwisu danego modelu są droższe?*
...
*A: czy to są koszty per car_id czy per model? Moze w tooltipie dodać informację, która nie wynika z wykresu? Np wiek samochodu i srednia liczba dzialan serwisowych w roku?*
